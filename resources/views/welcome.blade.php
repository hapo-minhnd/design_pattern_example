...
<div
    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
            <div class="grid grid-cols-1 md:grid-cols-2">
                <div class="p-6">
                    ...
                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            Mỗi lớp chỉ nên chịu trách nhiệm về một nhiệm vụ cụ thể nào đó mà thôi.
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                    ...
                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            Không được sửa đổi một class có sẵn nhưng có thể mở rộng bằng kế thừa.
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            Các đối tượng (instance) kiểu class con có thể thay thế các dối tượng kiểu class cha mà không gây ra lỗi.
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                    ...
                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            Thay vì dùng 1 interface lớn, ta nên tách thành nhiều interface nhỏ, với nhiều mục đích cụ thể.
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <img src="{{URL::asset('images/SOLID.png')}}" style="width: 100%"/>
        </div>
    </div>
</div>
</body>
